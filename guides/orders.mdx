...
<Steps>
  <Step title="Create a price quote" titleSize="h3">
  ...
  <br/>  With this information, you can call the [offer calculation endpoint](/api-reference/tariffs/calculate_price).
<br/>
  ...
  <Step title="Submit the order" titleSize="h3">
    When a customer has accepted the offer, you can use the API to submit the customer and order details to the RABOT platform with a [create new order](/api-reference/orders/create_order) call.<br/>
  ...
  <Step title="Check order status" titleSize="h3">
