...
After the order has been submitted successfully, you can use the [get order](api-reference/orders/get_orders) endpoint to follow the different processing states of the order.
