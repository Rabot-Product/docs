...
The Partner API can provide access to customer and contract data. Depending on the partnership scope and agreed data privacy policies, your API client will have a certain access scope assigned (see [Authentication](#authentication)), which controls the visibility of customer and contract information.
